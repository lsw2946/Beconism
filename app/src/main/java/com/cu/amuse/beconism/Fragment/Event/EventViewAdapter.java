...
public class EventViewAdapter  extends BaseAdapter {
    ...
    private ArrayList<EventViewItem> listViewItemlist = new ArrayList<EventViewItem>();
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        ImageView iconImageView = (ImageView) convertView.findViewById(R.id.eventImage);
        TextView titleTextView = (TextView) convertView.findViewById(R.id.eventName) ;
        TextView descTextView = (TextView) convertView.findViewById(R.id.eventDescription) ;
